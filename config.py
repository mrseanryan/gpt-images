...
OPENAI_IMAGE_MODEL = 'gpt-image-1' # gpt-image-1-mini [2026-03] gpt-image-1 [2025-11] - older: dall-e-2 or dall-e-3. dall-e-3 is better, but costs more and only 1 image at a time.
...
GAME_MODE_ENABLED = True  # Adjusts prompt for 2D game, top-down view.
GAME_SPRITE_MODE_TOP_DOWN__WALKING_DOWN = True  # If true is top-down, walking down. Else will be walking right.
REFERENCE_IMAGE_PATH = None # "output/alien-sprite-sheet--7_0.jpg"  # Optional reference image for style guidance. Set to None if not used.
